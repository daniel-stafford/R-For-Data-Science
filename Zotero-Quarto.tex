...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{library}\NormalTok{(rbbt)}
\end{Highlighting}
\end{Shaded}

This is a reference to a Zotero item
@azevedo-OneHealthPerspectives-2021.
